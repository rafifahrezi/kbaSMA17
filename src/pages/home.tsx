        ...
        <div className="flex min-h-screen flex-col">
            ...
            <section className="relative w-full overflow-hidden bg-primary/5 py-24 lg:py-32">
                ...
                <motion.div
                    ...
                    className="flex justify-center animate-in fade-in slide-in-from-top-4 duration-700 delay-100">
                    <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 animate-bounce">
                        <img src="./images/logo.png" alt="KBA17 Logo" className="w-full h-full object-contain drop-shadow-lg" />
                    </div>
                </motion.div>
                <div className="container relative z-10 mx-auto px-4 md:px-6">
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="mx-auto max-w-3xl space-y-8 text-center animate-in fade-in slide-in-from-bottom-8 duration-700">
                        <motion.h1
                            variants={fadeUp}
